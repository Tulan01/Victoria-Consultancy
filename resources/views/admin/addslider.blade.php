...
<div class="col col-md-12">
  <div align="center"><h2>Manage Slider Images</h2>
 </div>
      ...
      <hr>
		...
		<div class="table-responsive">
		     	<div class="col col-md-12">
		    <table id="slider" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
		    <thead>
		      <tr>
            <th>Serial</th>    
           <th>Image</th>
		     ...
		     <tbody id="newlog">
		       ...
		       <tr>
                  <td>{{$row->id}}</td>  
                   <td><img src="{{URL::to($row->slider_image)}}" style="width: 80px; height: 50px;"></td>		           
		           <td>
		       <a class="btn btn-info" href="{{URL::to('edit_slider'.$row->id)}}" id="edit"><i class="fa fa-edit" ></i></a>
		        <a class="btn btn-danger" href="{{URL::to('delete_slider'.$row->id)}}" id="delete"><i class="fa fa-trash" ></i></a>
                  </td>
               </tr>
             @endforeach
		     </tbody>
		          ...
		          @csrf 
                   ...
                   <div class="form-group row">
                        <label for="example-text-input" class="col-sm-4 col-form-label">Select Photo</label>
                         <div class="col-sm-8">
                            <input type="file" name="slider_image" id="slider_image" class=""/>
                          </div>
                     </div>
