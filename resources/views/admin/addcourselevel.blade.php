...
<div class="col col-md-12">
  <div align="center"><h2>Manage Course Level</h2>
 </div>
      ...
      <hr>
                         ...
                         <div class="col-md-4 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0 position">
                            <div class="align-items-center m-4 d-inline-flex">
                                <a class="btn btn-primary form-control" href="" data-toggle="modal" data-target="#formModal" id="create_record">
                                     <i class="fa fa-plus">Add Course Level</i>
                                </a>
                            </div>
                          </div>
		...
		<div class="table-responsive">
		     	<div class="col col-md-12">
		    <table id="course_level" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
		    <thead>
		      <tr>
            <th>Serial</th>    
		     ...
		     <tbody id="newlog">
		       ...
		       <tr>
                  <td>{{$row->id}}</td>  
		           ...
		           <td>
		       <a class="btn btn-info" href="{{URL::to('edit_course_level'.$row->id)}}" id="edit"><i class="fa fa-edit" ></i></a>
		        <a class="btn btn-danger" href="{{URL::to('delete_course_level'.$row->id)}}" id="delete"><i class="fa fa-trash" ></i></a>
                  </td>
               </tr>
             @endforeach
		     </tbody>
		   ...
		   <div class="modal-header">
		   	<h4 class="modal-title color">Add New Information</h4>
		        ...
		        <div class="modal-body">
		         ...
		         <form method="post"  action="{{route('storecourselevel')}}" enctype="multipart/form-data">
		          @csrf 

                   <div class="form-group row">
                        <label for="example-text-input" class="col-sm-4 col-form-label">Insert Data</label>
                         <div class="col-sm-8">
                            <input type="text" name="course_level_name" id="course_level_name" required="" />
                          </div>
                     </div>
...
<script type="text/javascript">
   ...
   var course_level = $('#course_level').DataTable({
                            sDom: 'lrtip',
                            "paging": false,
                             fixedHeader: true
                        });
    $('#course_level').on( 'keyup', function () {
    course_level.search( this.value ).draw();
