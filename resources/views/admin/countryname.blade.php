...
<div class="col col-md-12">
  <div align="center"><h2>Manage Countries</h2>
 </div>
      ...
      <hr>
		...
		<div class="table-responsive">
		     	<div class="col col-md-12">
		    <table id="country" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
		    <thead>
		      <tr>
            <th>Serial</th>    
           <th>Country Name</th>
		     ...
		     <tbody id="newlog">
		       ...
		       <tr>
                  <td>{{$row->id}}</td>  
		           ...
		           <td>
		       <a class="btn btn-info" href="{{URL::to('edit_country'.$row->id)}}" id="edit"><i class="fa fa-edit" ></i></a>
		        <a class="btn btn-danger" href="{{URL::to('delete_country'.$row->id)}}" id="delete"><i class="fa fa-trash" ></i></a>
                  </td>
               </tr>
             @endforeach
		     </tbody>
...
<script type="text/javascript">
   ...
   var country = $('#country').DataTable({
    ...
    country.search( this.value ).draw();
